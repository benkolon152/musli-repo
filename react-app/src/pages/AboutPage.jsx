    ...
    render(){
        return(
            <div style={{margin: '20px'}}>
                ...
                <p className="about-paragraph">
                  Thanks to its versatility and wholesome ingredients, muesli remains a favorite for health-conscious consumers worldwide. Whether classNameic, fruity, or nutty variations, it provides a delicious start to the day.
                </p>
            </div>
        )
    }
